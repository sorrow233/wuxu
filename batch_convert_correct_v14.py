...
def optimize_and_correct(cape_path, safe_name):
    ...
    try:
        ...
        plist_data['Author'] = "Master Pixel Cursors v14"
        ...
        # CLONING LOGIC v14:
        # If IBeam is NOT animated OR has very few frames, clone from Wait.
        # This handles cases where IBeam is just a static line but Wait is a character.
        master_key = None
        ...
        if master_key:
            ...
            # If IBeam is static (1 frame) or missing, and Wait is animated, replace it.
            if ibeam_frames <= 1:
                print(f"  - Replacing Static/Missing IBeam with {master_key} for {display_name}")
        ...
        print(f"Successfully Corrected v14: {display_name}")
...
def convert_folder(folder_path):
    ...
    except Exception as e: print(f"Error converting {folder_path}: {e}")
