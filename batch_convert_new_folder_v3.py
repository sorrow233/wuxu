...
def resize_cape_plist(cape_path, safe_name):
    ...
    try:
        ...
        # 3. FIX METADATA (NEW!)
        # Extract clean name from "【试用版】鼠标指针-芙宁娜--BLZ" -> "芙宁娜"
        # Logic: Find name between - and --, or just use the whole thing if fail
        ...
        plist_data['Author'] = "AI Converted"
...
def convert_folder(folder_path):
    ...
    try:
        ...
        # Pass the safe_name to use as CapeName
